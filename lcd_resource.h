...
static unsigned char gs_wifi_wan_st_res[MAX_WIFI_WAN_LEVELS][63/* LCD_WIFI_WAN_ST_IMG_W * ceil(LCD_WIFI_WAN_ST_IMG_W / 8) */] = 
{
    {
...
static unsigned char gs_cell_srv_st_res[MAX_CELL_WAN_LEVELS][96/* LCD_CELL_SRV_ST_IMG_W * ceil(LCD_CELL_SRV_ST_IMG_W / 8) */] = 
{
    {
...
static unsigned char gs_lcd_hotspot_res[/* LCD_HOTSPOT_IMG_W * ceil(LCD_HOTSPOT_IMG_H / 8) */] = 
{
...
static unsigned char gs_lcd_bat_res[BATTERY_LEVELS][99/* LCD_BAT_IMG_W * ceil(LCD_BAT_IMG_H / 8) */] = 
{
    {/*0*/
...
static unsigned char gs_lcd_charger_res[/* LCD_CHARGER_IMG_W * ceil(LCD_CHARGER_IMG_H / 8) */] = 
{
