...
static unsigned char gs_punc_colon_font[ /* PUNC_COLON_FONT_W * ceil(PUNC_COLON_FONT_W / 8) */] = 
{/* : */
...
static unsigned char gs_punc_dot_font[ /* PUNC_DOT_FONT_W * ceil(PUNC_DOT_FONT_W / 8) */] = 
{/* . */
...
static unsigned char gs_expo_st_idle_res[/* LCD_EXPO_ST_IMG_W * ceil(LCD_EXPO_ST_IMG_W / 8) */] = {};
static unsigned char gs_expo_st_exposing_res[/* LCD_EXPO_ST_IMG_W * ceil(LCD_EXPO_ST_IMG_W / 8) */] = {};
static unsigned char gs_expo_st_hv_disconn_res[/* LCD_EXPO_ST_IMG_W * ceil(LCD_EXPO_ST_IMG_W / 8) */] = {};
#define LCD_EXPO_ST_POS_X (LCD_STATIC_DEV_ST_POS_X + LCD_STATIC_DEV_ST_POS_W)
#define LCD_EXPO_ST_POS_Y (LCD_STATIC_DEV_ST_POS_Y)
#define LCD_EXPO_ST_POS_W 64 /*maximu width*/
